...
--dashboard
vim.keymap.set('n', '<leader>h', '<cmd>Alpha<cr>', { noremap = true, silent = false })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>dth', hide_diagnostics, { desc = '[d]iagnostics [t]oggle [h]ide' })
      vim.keymap.set('n', '<leader>dts', show_diagnostics, { desc = '[d]iagnostics [t]oggle [s]how' })
      -- Diagnostic Config
